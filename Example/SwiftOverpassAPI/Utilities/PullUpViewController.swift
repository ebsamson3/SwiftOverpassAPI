...
open class PullUpController: UIViewController {
    ...
    */
    ...
    private func setupConstraints() {
		...
		topConstraint = view.topAnchor.constraint(equalTo: safeArea.topAnchor)
		topConstraint?.priority = .defaultHigh
        leftConstraint = view.leftAnchor.constraint(equalTo: safeArea.leftAnchor)
    ...
    private func setLandscapeConstraints() {
        guard let parentViewHeight = parent?.view.frame.height else {
			return
		}
...
extension UIViewController {
    ...
    open func addPullUpController(_ pullUpController: PullUpController,
		...
		//Edward Smason: Commented out because it causes errors trying to layout contained tableviews prior to them being added to the app window.
